...
@InitiatingFlow
@StartableByRPC
public class SendMedicalStaffData extends FlowLogic<String> {
    ...
    public SendMedicalStaffData(String staffID, String staffName, String proficiency, String fromPharma, String toMedical) {
    ...
    public String call() throws FlowException {
        ...
        MedicalStaffState staffState = new MedicalStaffState(staffID, staffName, proficiency, new AnonymousParty(myKey), targetAcctAnonymousParty);

        final Party notary = getServiceHub().getNetworkMapCache().getNotaryIdentities().get(0);

        TransactionBuilder txbuilder = new TransactionBuilder(notary)
                .addOutputState(staffState)
        ...
        return "Successfully sent for staff ID: "+ staffID;
    }
}

@InitiatedBy(SendMedicalStaffData.class)
class SendMedicalStaffDataResponder extends FlowLogic<Void> {
    //private variable
    private FlowSession counterpartySession;

    //Constructor
    public SendMedicalStaffDataResponder(FlowSession counterpartySession) {
